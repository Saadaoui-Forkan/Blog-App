 ...
 * @access  private (only logged in user)
 ------------------------------------------------*/
const createCommentCtr = asyncHandler(async (req, res) => {
 ...
 * @access  private (only admin)
 ------------------------------------------------*/
 const getAllCommentsCtr = asyncHandler(async (req, res) => {
 ...
 * @access  private (only admin or owner of the comment)
 ------------------------------------------------*/
 const deleteCommentCtr = asyncHandler(async (req, res) => {
 ...
 * @access  private (only owner of the comment)
 ------------------------------------------------*/
  const updateCommentCtr = asyncHandler(async (req, res) => {
